...
server = 'SERVER_NAME'  # Cambiar por tu servidor de Azure
database = 'DATABASE_NAME'  # Cambiar por tu base de datos
username = 'USERNAME'  # Cambiar por tu usuario
password = 'PASWORD'  # Cambiar por tu contraseña
